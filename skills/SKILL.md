...
- `references/sdd-template.md` — 标准 SDD 文档模板（用于验证 spec 完整性）
- `references/stress-test-prompts.md` — 分层对抗性压力测试 Prompt 库（按项目类型组装 10-20 题）

详细的规划阶段流程（灵感捕获→AI 结构化→压力测试→反馈修正）请参阅 `references/planning-workflow.md`。
